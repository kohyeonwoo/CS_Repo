...
public class EnemyFSM : MonoBehaviour
{
   ...
   // private Transform projectileSpawnPoint;
    ...
    private EnemyMemoryPoool enemyMemoryPool; //적 메모리 풀(적 오브젝트 비활성화에 사용)
    ...
    //    private void Awake()
    public void SetUp(Transform target, EnemyMemoryPoool enemyMemoryPoool)
    {
        status = GetComponent<Status>();
        navMeshAgent = GetComponent<NavMeshAgent>();
        _animator = this.gameObject.GetComponent<Animator>();
        this.target = target;
        this.enemyMemoryPool = enemyMemoryPoool;  
    ...
    {
        isDead = status.DecreaseHP(damage);   
    }
